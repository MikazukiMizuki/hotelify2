                    ...
                    <div className="d-md-flex">
                        ...
                        <div className="col-md-3 ml-2 pt-sm-2">
                            ...
                            <ul className="list-unstyled d-flex flex-wrap align-md-items-center justify-md-content-center">
                                ...
                                <a href="https://www.facebook.com/HotelifyFornitureAlberghiere/?ref=page_internal" className="unstyled-link pe-auto" target='_blank'>
                                    <li className='my-1 mx-2'>
                                        <FiFacebook size={40} />
                                    </li>
                                </a>

                                <a href="https://twitter.com/hotelify" className="unstyled-link pe-auto" target='_blank'>
                                    <li className='my-1 mx-2'>
                                        <FiTwitter size={40} />
                                    </li>
                                </a>

                                <a href="https://www.instagram.com/hotelify_forniture_alberghiere/?hl=en" className="unstyled-link pe-auto" target='_blank'>
                                    <li className='my-1 mx-2'>
                                        <FiInstagram size={40} />
                                    </li>
                                </a>

                                <a href="https://www.youtube.com/watch?v=Ht1kVLpzbE8" className="unstyled-link pe-auto" target='_blank'>
                                    <li className='my-1 mx-2'>
                                        <FiYoutube size={40} />
                                    </li>
                                </a>

                                <a href="https://www.linkedin.com/company/hotelify-forniture-alberghiere/?trk=public_profile_experience-item_profile-section-card_image-click&originalSubdomain=it" className="unstyled-link pe-auto" target='_blank'>
                                    <li className='my-1 mx-2'>
                                        <FiLinkedin size={40} />
                                    </li>
                                </a>
